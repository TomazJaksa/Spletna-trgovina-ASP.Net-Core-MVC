    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddAuthentication()
                .AddGoogle(options =>
                {
                    options.ClientId = "610270812444-u99et1755d97o1tk7bnkgn4usq1ftpl3.apps.googleusercontent.com";
                    options.ClientSecret = "nChfJvPbQalXtd8xHGd628Lm";
                    options.SignInScheme = IdentityConstants.ExternalScheme;
                
                })
                .AddFacebook(options => {
                    options.AppId = "4825335217537007";
                    options.AppSecret = "11ccdd190c30424179f9dba161fb54dc";
                });
