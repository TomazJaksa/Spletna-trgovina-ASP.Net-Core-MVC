...
namespace Voleska.Controllers
{
    ...
    public class KatalogController : Controller
    {
        ...
        public KatalogController(Data.ApplicationDbContext context)
        {
            _context = context;
        ...
        public async Task<IActionResult> Details(int? id, string imeTipaIzdelka, bool naKomentarje)
        {
        ...
        public async Task<IActionResult> DodajVKosarico(int izdelekId,string opcijaParameter, int MaterialID, int kolicina, decimal cena)
        {
