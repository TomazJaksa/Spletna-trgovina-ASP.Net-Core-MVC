...
namespace Voleska.Controllers
{
    public class LajkaniBlogiController : Controller
    {
        ...
        public IActionResult GumbiReload(int blogId, string lajk, string dislajk, int steviloLike, int steviloDislike)
        {
            return ViewComponent(nameof(Voleska.ViewComponents.ViewComponents.LajkVC), new { blogId = blogId, like = lajk, dislike = dislajk, steviloLike = steviloLike, steviloDislike = steviloDislike });
        }
