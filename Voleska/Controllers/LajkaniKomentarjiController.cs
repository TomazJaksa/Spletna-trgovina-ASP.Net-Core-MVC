...
namespace Voleska.Controllers
{
    public class LajkaniKomentarjiController : Controller
    {
        ...
        public IActionResult GumbiReload(int komentarId, int blogId, string lajk, string dislajk, int steviloLike, int steviloDislike)
        {
            return ViewComponent(nameof(Voleska.ViewComponents.ViewComponents.LajkKomentarVC), new {komentarId = komentarId,  blogId = blogId, like = lajk, dislike = dislajk, steviloLike = steviloLike, steviloDislike = steviloDislike });
        }
