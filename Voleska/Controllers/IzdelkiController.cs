...
namespace Voleska.Controllers
{
    ...
    public class IzdelkiController : Controller
    {
        ...
        public IzdelkiController(Data.ApplicationDbContext context)
        {   
            _context = context;
        ...
        public async Task<IActionResult> Index(string izbranTipIzdelka, string SearchString, string filtriranje, int? stevilkaStrani, int? kliknjenLinkStrani)
        {
            ...
            int steviloPrikazanihIzdelkov = 3;
        ...
        public async Task<IActionResult> Create([Bind("Ime,Opis,Podrobnosti,Cena,MaterialID,TipIzdelkaID")] Izdelek izdelek)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Ime,Opis,Podrobnosti,Cena,Izbrisan,Posodobljen, PovprecnaOcena, MaterialID,TipIzdelkaID")] Izdelek izdelek)
        {
            if (id != izdelek.ID)
            {
                return NotFound();
