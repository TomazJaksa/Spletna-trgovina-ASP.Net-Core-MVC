...
namespace Voleska.Controllers
{
    ...
    public class TransakcijeController : Controller
    {
        ...
        [AllowAnonymous]
        public async Task<IActionResult> Details(int? id, string searchString, string searchString2, string searchString3, int? stevilkaStrani, string filtriranje, string izborTransakcij, string prejsnjaVrednostIzbora, string izbira1, string izbira2, string izbira3)
        {
            if (id == null)
            {
                return NotFound();
            ...
            ViewData["Zakljuceno"] = izbira1;
            ViewData["Odposlano"] = izbira2;
            ViewData["VTeku"] = izbira3;
