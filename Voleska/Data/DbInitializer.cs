...
Microsoft.AspNetCore.Identity.RoleManager<ApplicationRole> roleManager)
        {
           ...
           {
            new TipIzdelka{Ime="Uhani"},
            new TipIzdelka{Ime="Broške"},
            new TipIzdelka{Ime="Zapestnice"},
            new TipIzdelka{Ime="Ogrlice"},
            new TipIzdelka{Ime="Prstani"},
            new TipIzdelka{Ime="Obeski za ključe"}
           };
