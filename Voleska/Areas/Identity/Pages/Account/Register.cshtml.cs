...
namespace Voleska.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Remote(action: "IsUsernameInUse", controller: "FormValidator", ErrorMessage = "Uporabniško ime že v uporabi!")]
            ...
            [Display(Name = "Email")]
            [Remote(action:"IsEmailInUse",controller: "FormValidator", ErrorMessage = "E-naslov že v uporabi!")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (narocnina==true) {
                    var naroci = new Novice { Email = user.Email, Dodan = DateTime.Now, Posodobljen = DateTime.Now};
                    _context.Add(naroci);
